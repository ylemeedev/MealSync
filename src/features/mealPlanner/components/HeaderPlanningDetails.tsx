...
import { HeaderPlanningDetailsprops } from "../types/mealPlanner.types";

export const HeaderPlanningDetails = ({ name, handlePlanningGenerate }: HeaderPlanningDetailsprops) => {
    return (
        <HeaderContainer>
